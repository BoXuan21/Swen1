    ...
    public partial class TcpServer
    {
        public async Task HandleBattleAsync(CustomHttpContext context)
        {
            try 
            {
                ...
                if (string.IsNullOrEmpty(username)) //check username exist
                {
                ...
                //holt beide spieler aus dem request body
        ...
        private async Task HandleGetScoreboardAsync(CustomHttpContext context)
        {
            ...
            {     // Holt alle User
                ...
                // Sortiert nach ELO und erstellt Rangliste
